...
/**
 * Fluent helper to fetch a single {@link com.sdk2.thirdtrial.Model.External.BusinessPartner.namespaces.businesspartner.SupplierCompany SupplierCompany} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
    ...
    extends FluentHelperByKey<SupplierCompanyByKeyFluentHelper, SupplierCompany, SupplierCompanySelectable>
{
    ...
    /**
     * Creates a fluent helper object that will fetch a single {@link com.sdk2.thirdtrial.Model.External.BusinessPartner.namespaces.businesspartner.SupplierCompany SupplierCompany} entity with the provided key field values. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
     * @param companyCode
